...
def test_milestone6_coverage_alias_repo_has_no_critical_path_gap(tmp_path: Path) -> None:
    repo_path = Path(__file__).resolve().parents[1] / "eval" / "repos" / "milestone6_coverage_aliases"
