...
def test_milestone9_django_missing_tests_repo_flags_critical_path_gap(tmp_path: Path) -> None:
    repo_path = Path(__file__).resolve().parents[1] / "eval" / "repos" / "milestone9_django_missing_tests"
